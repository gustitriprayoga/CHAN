...
const apivhtear = 'NOT-PREMIUM';
const apibarbar = 'mhankbarbar';
const BotName = 'KANA BOT'; 
const instagram = '@gustitriprayoga'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'KANA\n' // Nama kamu
            + 'KANNA:BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6285156147636:+62 851-5614-7636\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
